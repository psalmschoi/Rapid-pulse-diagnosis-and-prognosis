...
def Grid_Search(RPT_MODE, time_lower, time_upper, X = None, Y = None):
    ...
    for i in range(1,14) :
        SOC_Range = [j for j in range(i,i+4)]
...
if __name__ == "__main__":
    ...
    row_idx, col_idx, r_list, a_list, report_r_max, report_a_min = Grid_Search(RPT_MODE, time_lower, time_upper)
